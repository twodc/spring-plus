    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        try {
            ...
            Log log = new Log(
                    ...
                    managerUser.getId(),
                    ActionType.SUCCESS,
                    String.format("%s님이 %s님을 담당자로 등록했습니다.", user.getNickname(), managerUser.getNickname())
            );
    ...
    public void deleteManager(AuthUser authUser, long todoId, long managerId) {
        try {
            ...
            Log log = new Log(
                    ...
                    managerId,
                    ActionType.SUCCESS,
                    String.format("%s님이 %s님을 담당자에서 삭제했습니다.", user.getNickname(), manager.getUser().getNickname())
            );
            logService.saveLog(log);
